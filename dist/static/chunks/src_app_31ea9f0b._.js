(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_app_31ea9f0b._.js", {

"[project]/src/app/store/useAuth.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/src/app/store/useNote.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$store$2f$useAuth$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/store/useAuth.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$_Components$2f$providers$2f$tanstack$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/_Components/providers/tanstack.tsx [app-client] (ecmascript)");
...
function useNote() {
    _s();
    let { token } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$store$2f$useAuth$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    ...
    let notesData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        queryKey: [
            "getUserNotes"
        ],
        queryFn: getNotes,
    ...
    let addResponse = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: addNote,
        onMutate: {
            "useNote.useMutation[addResponse]": ({ title, content })=>{
                const oldData = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$_Components$2f$providers$2f$tanstack$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["queryCLient"].getQueryData([
                    "getUserNotes"
                ]);
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$_Components$2f$providers$2f$tanstack$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["queryCLient"].setQueryData([
                    'getUserNotes'
                ], {
                    ...oldData,
                    notes: [
        ...
        }["useNote.useMutation[addResponse]"],
        onError: {
            "useNote.useMutation[addResponse]": (error)=>{
                console.log(error);
            }
        }["useNote.useMutation[addResponse]"]
    });
    ...
    const updateResponse = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: updateNote,
        onMutate: {
            "useNote.useMutation[updateResponse]": ({ values, noteId })=>{
                const oldData = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$_Components$2f$providers$2f$tanstack$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["queryCLient"].getQueryData([
                    "getUserNotes"
                ]);
                const selectedIndex = oldData?.notes?.findIndex({
                    "useNote.useMutation[updateResponse]": (note)=>note._id === noteId
                }["useNote.useMutation[updateResponse]"]);
        ...
        onError: {
            "useNote.useMutation[updateResponse]": (error)=>{
                console.log(error);
            }
        }["useNote.useMutation[updateResponse]"]
    });
    ...
    const deleteResponse = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: deleteNote,
        onMutate: {
            "useNote.useMutation[deleteResponse]": (noteId)=>{
                const oldData = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$_Components$2f$providers$2f$tanstack$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["queryCLient"].getQueryData([
                    'getUserNotes'
                ]);
                const newData = oldData?.notes.filter({
                    "useNote.useMutation[deleteResponse]": (note)=>note._id !== noteId
                }["useNote.useMutation[deleteResponse]"]);
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$_Components$2f$providers$2f$tanstack$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["queryCLient"].setQueryData([
                    'getUserNotes'
                ], {
                    ...oldData,
        ...
        onError: {
            "useNote.useMutation[deleteResponse]": (error)=>{
                console.log(error);
            }
        }["useNote.useMutation[deleteResponse]"]
    });
...
_s(useNote, "AY6zCzV0YbPNNnXUTaYOzjMo2OI=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$store$2f$useAuth$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"],
...
"[project]/src/app/_Components/viewCard.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/src/app/_Components/noteInput.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$store$2f$useNote$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/store/useNote.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$Button$2f$Button$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Button$3e$__ = __turbopack_context__.i("[project]/node_modules/@mui/material/Button/Button.js [app-client] (ecmascript) <export default as Button>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$Typography$2f$Typography$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Typography$3e$__ = __turbopack_context__.i("[project]/node_modules/@mui/material/Typography/Typography.js [app-client] (ecmascript) <export default as Typography>");
...
function NoteInput({ editing, setEditing, note, setNote }) {
    _s();
    const { addResponse, updateResponse } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$store$2f$useNote$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])();
    const { handleSubmit, handleChange, values, setValues } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$formik$2f$dist$2f$formik$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useFormik"])({
        initialValues: {
            title: "",
            content: ""
        },
        onSubmit: {
            "NoteInput.useFormik": (values)=>{
    ...
    const auth = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$store$2f$useAuth$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
...
_s(NoteInput, "S2DM4m0+H4u47CE0M3EkdqZwy64=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$store$2f$useNote$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"],
...
_c = NoteInput;
var _c;
__turbopack_context__.k.register(_c, "NoteInput");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
"[project]/src/app/_Components/noteCard.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$_Components$2f$viewCard$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/_Components/viewCard.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$_Components$2f$noteInput$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/_Components/noteInput.tsx [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
function NoteCard() {
    _s();
    let { notesData: { data }, deleteResponse, addResponse } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$store$2f$useNote$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])();
    ...
    const [reading, setReading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
        children: [
            reading && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$_Components$2f$viewCard$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                reading: reading,
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$_Components$2f$noteInput$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$Typography$2f$Typography$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                children: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$moment$2f$moment$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(note.createdAt).format("LL")
                                            }, void 0, false, {
                                                fileName: "[project]/src/app/_Components/noteCard.tsx",
                                                lineNumber: 72,
                                                columnNumber: 19
...
_s(NoteCard, "XSR+A7XLAQfpp4O+GwhpD8+9NZ0=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$store$2f$useNote$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]
    ];
});
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$_Components$2f$noteCard$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/_Components/noteCard.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$store$2f$useAuth$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/store/useAuth.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/navigation.js [app-client] (ecmascript)");
;
...
function Home() {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$Container$2f$Container$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Container$3e$__["Container"], {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$Box$2f$Box$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Box$3e$__["Box"], {
            ...
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$_Components$2f$noteCard$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {}, void 0, false, {
...
//# sourceMappingURL=src_app_31ea9f0b._.js.map